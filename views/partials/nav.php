            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class=" <?= isUri('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium text-white" aria-current="page">Dashboard</a>
                        <a href="/notes" class=" <?= isUri('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium text-white" aria-current="page">Notes</a>
                            ...
                            <?php if (isset($_SESSION['user']) === true): ?>
                                <div class="flex justify-center items-center gap-6">
                                    <form method="post" action="/session/destroy">
                                        ...
                                        <button type="submit" class="text-white py-1 px-3 bg-slate-700 rounded-lg hover:bg-slate-900 duration-150 transition-all">Logout</button>
                                    </form>
